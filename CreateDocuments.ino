...
#define API_KEY "AIzaSyCDzXjejfqUyOJFUlzql8bdkJItwD5GUJY"

/* 3. Define the project ID */
#define FIREBASE_PROJECT_ID "equipo-reto"
/* 4. Define the user Email and password that alreadey registerd or added in your project */
#define USER_EMAIL "a01641585@tec.mx"
#define USER_PASSWORD "VelXVelY_0,0"
...
void loop()
{
    ...
    if (Firebase.ready() && (millis() - dataMillis > 60000 || dataMillis == 0))
    {
        ...
        String documentPath = "a0/b0" + String(count);
